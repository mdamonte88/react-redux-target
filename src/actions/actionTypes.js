...
export const SELECT_TARGET_SUCCESS = 'SELECT_TARGET_SUCCESS';
export const UNSELECT_TARGET_SUCCESS = 'UNSELECT_TARGET_SUCCESS';
export const REMOVE_TARGET_SUCCESS = 'REMOVE_TARGET_SUCCESS';
export const REMOVE_TARGET_FAILED = 'REMOVE_TARGET_FAILED';
